          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-muted-foreground hover:text-foreground transition-colors rounded focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
              >
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary hover:underline rounded focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                  >
                    textarea.my
                  </a>
                  .

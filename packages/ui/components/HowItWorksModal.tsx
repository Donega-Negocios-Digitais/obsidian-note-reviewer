...
export const HowItWorksModal: React.FC<HowItWorksModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <BaseModal
      ...
      contentClassName="bg-card border border-border rounded-xl w-full max-w-2xl shadow-2xl relative"
    >
      <div role="dialog" aria-modal="true" aria-labelledby="help-video-title">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h3 id="help-video-title" className="font-semibold text-sm">Como o Obsidian Note Reviewer Funciona</h3>
          <button
            onClick={onClose}
            className="p-1.5 rounded-md hover:text-red-500 hover:bg-red-500/10 text-muted-foreground transition-colors"
          >

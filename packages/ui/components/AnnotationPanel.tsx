...
const AnnotationCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      {annotation.author && (
        <div
          className="flex items-center gap-1.5 text-[10px] font-mono truncate mb-1.5 text-muted-foreground"
          title={annotation.authorEmail ? `${annotation.author} (${annotation.authorEmail})` : annotation.author}
        >

...
const tabs: Array<{ id: CategoryTab; emoji: string; label: string }> = [
  ...
  { id: 'idioma', emoji: '🌐', label: 'Idioma' }, // NEW
];
```
...
4. 9th category "Idioma" appears in sidebar with 🌐 icon
...
<output>
After completion, create `.planning/phases/08-configuration-system/plans/08-05-SUMMARY.md` with:

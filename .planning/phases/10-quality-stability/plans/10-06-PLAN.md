...
// packages/core/src/i18n/locales/pt-BR.json
{
  ...
  "annotation": {
    ...
    "none": "Nenhuma anotação ainda",
    "empty": "Adicione anotações ao documento para começar a revisar",
    "status": {
      "open": "Aberta",
  ...
  "validation": {
    ...
    "minLength": "Muito curto. Mínimo: {{min}} caracteres.",
    "maxLength": "Muito longo. Máximo: {{max}} caracteres."
  }
}
```
...
```typescript
// In translation file
"count_annotations": "Uma anotação",
"count_annotations_plural": "{{count}} anotações"

...
> Historical normalization note (2026-02-12): environment variable names were updated to current project conventions (`VITE_*` for frontend). Original plan intent was preserved.
...
2. Check that all environment variables are referenced: grep -r "VITE_SUPABASE" lib/supabase/

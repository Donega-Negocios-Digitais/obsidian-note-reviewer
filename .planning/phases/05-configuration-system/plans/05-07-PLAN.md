...
@.planning/phases/05-configuration-system/plans/05-01-SUMMARY.md
@.planning/phases/05-configuration-system/plans/05-02-SUMMARY.md
@.planning/phases/05-configuration-system/plans/05-06-SUMMARY.md
...
<output>
After completion, create `.planning/phases/05-configuration-system/plans/05-07-SUMMARY.md` with:
- Routes removed
- Files deleted

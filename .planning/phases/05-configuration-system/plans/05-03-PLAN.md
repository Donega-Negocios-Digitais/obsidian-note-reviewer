...
<objective>
Redesign the content-related settings categories (Regras, Workflows, Conteúdo de Terceiros, Notas Atômicas, Notas Organizacionais, Conteúdo Próprio) with improved UX and Apple-style form design.
...
3. Apply to all 5 content categories:
   - 📚 Conteúdo de Terceiros (terceiros)
   - ⚛️ Notas Atômicas (atomica)
   - 🗺️ Notas Organizacionais (organizacional)
   - ✍️ Conteúdo Próprio (alex)
...
<output>
After completion, create `.planning/phases/05-configuration-system/plans/05-03-SUMMARY.md` with:

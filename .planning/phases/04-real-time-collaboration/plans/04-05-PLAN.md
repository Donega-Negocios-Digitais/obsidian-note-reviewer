...
> Historical normalization note (2026-02-12): environment variable names were aligned to current frontend conventions (`VITE_*`). Plan behavior and scope were not changed.

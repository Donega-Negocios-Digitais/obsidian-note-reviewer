...
> Historical normalization note (2026-02-12): environment/security guidance in this historical plan was aligned to current conventions (`VITE_*` frontend and server-only secrets).
